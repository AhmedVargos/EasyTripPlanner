...
import fallenleafapps.com.tripplanner.ui.adapters.CustomAdapter;
import fallenleafapps.com.tripplanner.utils.ConstantsVariables;

/**
 * Created by mohamed hesham on 3/31/2018.
 */
...
public class FloatingWidgetService extends Service {
    ...
    public void setList(){
        ...
        CustomAdapter customAdapter=new CustomAdapter(this,list,trip);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        trip=intent.getParcelableExtra(ConstantsVariables.TRIP_OBJ);
        Log.i("hello",trip.getTripName());
        list=trip.getNotes();
